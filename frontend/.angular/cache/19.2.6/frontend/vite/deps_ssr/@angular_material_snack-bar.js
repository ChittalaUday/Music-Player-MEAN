...
var OverlayRef = class {
  ...
  _renders = new import_rxjs13.Subject();
  _afterRenderRef;
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators9.takeUntil)((0, import_rxjs13.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _enterFallback;
  _exitFallback;
  _renders = new import_rxjs15.Subject();
  ...
  enter() {
    if (!this._destroyed) {
      ...
      if (this._animationsDisabled) {
        this._renders.pipe((0, import_operators11.take)(1)).subscribe(() => {
